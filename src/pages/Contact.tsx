        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 650px) 1fr', gap: '40px', position: 'relative' }}>
          ...
          <div className="contact-info-panel" style={{ position: 'relative' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: '15px', paddingLeft: '30px' }}>
              ...
              {/* Email Card */}
              <div className="info-card-premium" style={{ backgroundColor: 'white', padding: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', display: 'grid', gridTemplateColumns: '40px minmax(0, 1fr)', gap: '15px', alignItems: 'center' }}>
                <div style={{ color: '#333' }}>
                ...
                <div style={{ overflow: 'hidden' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <a href={`mailto:${COMPANY.emailSales}`} style={{ fontWeight: '600', color: '#ff5722', textDecoration: 'none', whiteSpace: 'nowrap', fontSize: 'clamp(11px, 3.5vw, 16px)' }}>{COMPANY.emailSales}</a>
                    <a href={`mailto:${COMPANY.emailViswa}`} style={{ fontWeight: '600', color: '#ff5722', textDecoration: 'none', whiteSpace: 'nowrap', fontSize: 'clamp(11px, 3.5vw, 16px)' }}>{COMPANY.emailViswa}</a>
                  </div>
                </div>
              </div>
              ...
              <a href={`https://wa.me/${COMPANY.phoneDisplay.replace(/[\s+]/g, '')}`} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                <div className="info-card-premium" style={{ backgroundColor: 'white', padding: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', display: 'grid', gridTemplateColumns: '40px minmax(0, 1fr)', gap: '15px', alignItems: 'center' }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontWeight: '600', color: '#ff5722', margin: 0, whiteSpace: 'nowrap', fontSize: 'clamp(11px, 3.5vw, 16px)' }}>Chat with us </p>
                  </div>
                </div>
              </a>
              ...
              <a href={`https://${COMPANY.website}`} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                <div className="info-card-premium" style={{ backgroundColor: 'white', padding: '25px', boxShadow: '0 10px 30px rgba(0,0,0,0.08)', display: 'grid', gridTemplateColumns: '40px minmax(0, 1fr)', gap: '15px', alignItems: 'center' }}>
                  ...
                  <div style={{ overflow: 'hidden' }}>
                    ...
                    <p style={{ fontWeight: '600', color: '#ff5722', margin: 0, whiteSpace: 'nowrap', fontSize: 'clamp(11px, 3.5vw, 16px)' }}>{COMPANY.website}</p>
                  </div>
                </div>
              </a>
